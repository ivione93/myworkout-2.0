...
public class AdapterTrainingCopy extends RecyclerView.Adapter<AdapterTrainingCopy.ViewHolderTrainings> implements Filterable {

    List<Training> listTrainings;
    List<Training> listTrainingsFull;

    public AdapterTrainingCopy(List<Training> listTrainings) {
